...
def Arm_with_Mobile(theta, theta2, theta3):
    ...
    # Link3
    p3 = np.array([L2_len*np.sin(theta2)+L3_len/2*np.sin(theta2+theta3),0.,L1_len+L2_len*np.cos(theta2)+L3_len/2*np.cos(theta2+theta3)])
