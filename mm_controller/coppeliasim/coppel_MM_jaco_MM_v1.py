...
Scout = sim.getObject('./base_link_visual')
...
try:
    ...
    while True:#(t := sim.getSimulationTime()) < total_time:
        ...
        X_c = np.array(X_c)
        X_m = sim.getObjectPosition(Scout, -1)
        X_m = np.array(X_m)
        ...
        x_m.append(X_m[0])
        y_m.append(X_m[1])
        e_x.append(X_d[0]-X_c[0])
        e_y.append(X_d[1]-X_c[1])
        e_z.append(X_d[2]-X_c[2])
        ...
        if np.linalg.norm(d_goal) < 0.024:
            ...
            # plt.subplot(1,3,1)
            # plt.plot(t, x_des, label="x_des", color="red")
            # plt.plot(t, x_ee, label="x_EE", color="green")
            # plt.plot(t, x_m, label="x_m", color="blue")
            # plt.xlabel("time")
            # plt.ylabel("X-axis")
            # plt.legend()
            # plt.subplot(1,3,2)
            # plt.plot(t, y_des, label="y_des", color="red")
            # plt.plot(t, y_ee, label="y_EE", color="green")
            # plt.plot(t, y_m, label="y_m", color="blue")
            # plt.xlabel("time")
            # plt.ylabel("Y-axis")
            # plt.legend()
            # plt.subplot(1,3,3)
            # plt.plot(t, z_des, label="z_des", color="red")
            # plt.plot(t, z_ee, label="z_EE", color="green")
            # plt.xlabel("time")
            # plt.ylabel("Z-axis")
            # plt.legend()
            # plt.show()
            ...
            # plt.figure()
            # plt.subplot(1,3,1)
            # plt.plot(t, e_x, label="error_x", color="red")
            # plt.xlabel("time")
            # plt.ylabel("X-error")
            # plt.legend()
            # plt.subplot(1,3,2)
            # plt.plot(t, e_y, label="error_y", color="red")
            # plt.xlabel("time")
            # plt.ylabel("Y-error")
            # plt.legend()
            # plt.subplot(1,3,3)
            # plt.plot(t, e_z, label="error_z", color="red")
            # plt.xlabel("time")
            # plt.ylabel("Z-error")
            # plt.legend()
            # plt.show()
